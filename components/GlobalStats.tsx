...
export default function GlobalStats({ bosses, worlds }: GlobalStatsProps) {
  ...
  const categories: string[] = ['Archdemons', 'POI', 'Criaturas'];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-surface border border-border rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-medium text-white">Top 10 Mais Mortos</h2>
            </div>
            <CategoryDropdown
          ...
          <div className="space-y-1">
            ...
            {topKilledBosses.length === 0 && (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                />
                <p className="text-secondary text-xs">Nenhum boss encontrado</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-surface border border-border rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-medium text-white">Top Servidores Ativos</h2>
            </div>
            <CategoryDropdown
            ...
            {serverStats.length === 0 && (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                <img
                  ...
                  className="w-8 h-8 mb-2 object-contain opacity-60"
                />
                <p className="text-secondary text-xs">Sem dados de servidor</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-surface border border-border rounded-lg p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-sm font-medium text-white">Resumo de Estatísticas</h2>
          </div>
            ...
            {serverStats.length > 0 && (
              <div className="p-4 bg-surface-hover/30 rounded-lg border border-border/50">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  />
                  <p className="text-secondary text-xs">Mundo Mais Ativo (Geral)</p>
                </div>
